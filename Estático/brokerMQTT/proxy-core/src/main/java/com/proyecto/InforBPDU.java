...
public class InforBPDU {
	...
	public int coste_enlace; // Coste del enlace entre ambos brokers
	public int coste_hasta_el_ROOT; // Coste del broker de ID y port, hasta el ROOT
	public Broker broker;
	//public String linkStatus; // Link status. Could be: {"root", "established", "blocked"}

	public InforBPDU (String _ID, String _port, int _coste_enlace, int _coste_hasta_el_ROOT, Broker _broker) {
		ID = _ID;
		port = _port;
